...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HomeBackgroundImage'
        db.create_table(u'mthompson_homebackgroundimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('nav_appearance', self.gf('django.db.models.fields.CharField')(default='Light', max_length=255, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'mthompson', ['HomeBackgroundImage'])


    def backwards(self, orm):
        # Deleting model 'HomeBackgroundImage'
        db.delete_table(u'mthompson_homebackgroundimage')
