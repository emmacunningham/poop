...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaCollection.order'
        db.add_column(u'mthompson_mediacollection', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaCollection.order'
        db.delete_column(u'mthompson_mediacollection', 'order')
