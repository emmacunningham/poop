...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SiteGallery'
        db.delete_table(u'mthompson_sitegallery')

        # Adding model 'MediaCollection'
        db.create_table(u'mthompson_mediacollection', (
        ...
        db.send_create_signal(u'mthompson', ['MediaCollection'])


    def backwards(self, orm):
        # Adding model 'SiteGallery'
        db.create_table(u'mthompson_sitegallery', (
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mthompson.Category'], null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('media_collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Gallery'], null=True, blank=True)),
        ))
        db.send_create_signal(u'mthompson', ['SiteGallery'])

        # Deleting model 'MediaCollection'
        db.delete_table(u'mthompson_mediacollection')
