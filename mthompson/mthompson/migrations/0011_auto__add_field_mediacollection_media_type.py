...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mthompson_mediacollection', 'media_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mthompson_mediacollection', 'media_type')
    ...
    models = {
        ...
        u'mthompson.mediacollection': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
