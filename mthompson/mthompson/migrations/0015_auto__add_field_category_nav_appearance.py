...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.nav_appearance'
        db.add_column(u'mthompson_category', 'nav_appearance',
                      self.gf('django.db.models.fields.CharField')(default='Light', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.nav_appearance'
        db.delete_column(u'mthompson_category', 'nav_appearance')
